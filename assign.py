...
# WE USE THE "gene", "protein_coding_gene", "pseudogene", "pseudogenic_tRNA", "rRNA_gene", "RNA", "snoRNA_gene", "snRNA_gene", "tRNA_gene"
...
for line in gff_file:
    ...
    #if items[2] == "gene":
    # version 21
    # CHANGEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD
    #if items[2] in ("transposable_element","gene", "transposable_element_gene", "pseudogene", "pseudogenic_tRNA", "rRNA",  "snoRNA", "snRNA", "tRNA"):
    if items[2] == "gene":
        # version 21
...
for chrx in table.keys():
    table_blocks[chrx] = dict((block, [])
                              for block in range(0, 100000000, block_span))
for chrx in table.keys():
